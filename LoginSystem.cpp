...
bool isStrongPassword(const string& password) {
    ...
    if (!hasUpper) cout << "Password does not have an uppercase letter." << endl;
    if (!hasLower) cout << "Password does not have a lowercase letter." << endl;
    if (!hasDigit) cout << "Password does not have a digit." << endl;
    if (!hasSpecial) cout << "Password does not have a special character." << endl;
